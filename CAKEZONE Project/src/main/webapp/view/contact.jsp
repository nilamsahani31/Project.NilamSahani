...
<body>
            ...
            <div class="col-lg-4 text-center bg-secondary py-3">
                <div class="d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="text-start">
                        ...
                        <span>nilamsahani2001@gmail.com</span>
                    </div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="loginpage" class="navbar-brand d-block d-lg-none">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                <a href="loginpage" class="nav-item nav-link">Home</a>
                <a href="aboutpage" class="nav-item nav-link">About Us</a>
                <a href="menupage" class="nav-item nav-link">Menu & Pricing</a>
                <a href="teampage" class="nav-item nav-link">Master Chefs</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu m-0">
                        <a href="servicepage" class="dropdown-item">Our Service</a>
                        <a href="testimonialpage" class="dropdown-item">Testimonial</a>
                    </div>
                </div>
                <a href="contactpage" class="nav-item nav-link active">Contact Us</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        ...
                        <span>Asthavinayak Colony Len No-10, Karvenagar Pune-52.</span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                ...
                <div class="col-lg-6">
                    <form action ="contactdata" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control bg-light border-0 px-4" placeholder="Mobile No" name="mobile" style="height: 55px;">
                            </div>
                            <div class="col-sm-12">
                                <textarea class="form-control bg-light border-0 px-4 py-3" rows="4" placeholder="Address"name="address" ></textarea>
                            </div>
                            <div class="col-sm-12">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Asthavinayak Colony Len No-10, Karvenagar Pune-52.</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">nilamsahani2001@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+91 9156416253</p>
                            </div>
